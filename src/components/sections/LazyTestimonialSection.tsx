...
import UltraStaggeredReveal from '@/components/animations/UltraStaggeredReveal';
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-gray-50 to-white" aria-labelledby="testimonials-heading">
      <div className="container mx-auto px-4">
        <UltraStaggeredReveal variant="elastic" intensity="medium" pattern="center-out">
          <SectionHeading 
