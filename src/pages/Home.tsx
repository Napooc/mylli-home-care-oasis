...
const services = [{
  ...
  <button onClick={() => scrollToSection('testimonials-heading')} className="text-center p-3 sm:p-4 backdrop-blur-sm bg-white/15 rounded-xl border border-white/30 hover:border-mylli-secondary/50 transition-all duration-300 hover:scale-105 cursor-pointer group">
    <p className="text-lg sm:text-xl md:text-2xl font-bold text-white group-hover:text-mylli-secondary">{isVisible ? '+6100' : '0'}</p> {/* Change hover text color */}
